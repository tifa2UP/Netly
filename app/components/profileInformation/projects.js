...
var Project = React.createClass({
	...
	projectHeading: function(){
		if(this.props.isCurrentUser){
			return <h2 style={{color: "#0077B5"}}>Projects <button className="btn btn-default" onClick={this.handleClickAdd}><span className="glyphicon glyphicon-plus" title="Add Projects"></span></button></h2>
		}else{
			...
			return(
				<div>
					{this.state.projects.map((project,index) => (
			        	<div key={index}>
			       			<h4><strong>{project.name}</strong> <button className="btn btn-default" onClick={this.handleClickEdit.bind(null, index)}><span className="glyphicon glyphicon-pencil" title ="Edit Projects"></span></button></h4>
